...
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 同步日志管理<span class="c-gray en">&gt;</span>卡务信息日志<a class="btn btn-success radius r mr-20" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
...
<!-- 隐藏的搜索模块 -->
	<div class="text-c form form-horizontal banner_xiala"> 
		<div class="row cl">
			...
			<div class="formControls col-2" >
				<input id="s_no" type="text" class="input-text" placeholder="请输入卡号">
			</div>
		...
		<div class="row cl">
		 <label class="form-label col-1">修改时间:</label>
			...
			<div class="formControls col-2" >
			    <jc:selectDictionaryByKey_Code classname="input-text"   key="cardTypeCode" id="s_TypeCode" name="cardTypeCode"></jc:selectDictionaryByKey_Code>  
			</div>
		</div>
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-10"> 
        <span class="l">
            <jc:operationButton classname="btn btn-primary radius" onclick="changeSyncStatus();" btnSn="0101100501" btnName="同步" icon="&#xe6e1;"></jc:operationButton>
        </span> 
    </div>
    <!-- list -->
    <div class="mt-10">
            ...
            <thead>
                <tr class="text-c">
                   <th width="2%">
                    ...
                    <th width="8%">姓名</th>
                     <th width="17%" style="">卡号</th>
                     <th width="7%">卡类别</th>
                    <th width="7%">前置机</th>
                    <th width="12%">前置机地址</th>
                    <th width="8%">前置机状态</th>
                    <th width="7%">同步状态</th>
                    <th width="8%">创建时间</th>
                    <th width="8%">修改时间</th>
   ...
   <%@ include file="../commons/comm_const_js.jsp"%>
	...
	<script type="text/javascript" src="${contextPath}/js/syncLog/cardSyncLog.js?v=${appVerDate}"></script>
</body> 
</html>
