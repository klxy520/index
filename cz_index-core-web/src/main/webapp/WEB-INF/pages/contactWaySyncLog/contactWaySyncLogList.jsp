...
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 同步日志管理<span class="c-gray en">&gt;</span>联系方式日志<a class="btn btn-success radius r mr-20" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
...
<!-- 隐藏的搜索模块 -->
	<div class="text-c form form-horizontal banner_xiala"> 
		<div class="row cl">
			...
			<div class="formControls col-2" >
				<input id="s_no" type="text" class="input-text" placeholder="请输入联系号码">
			</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-2" >
				<jc:selectDictionaryByKey_Code classname="input-text" key="contactWayTypeCode" id="s_TypeCode" ></jc:selectDictionaryByKey_Code>   
			</div>
		</div>
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-10"> 
        <span class="l">
            <jc:operationButton classname="btn btn-primary radius" onclick="changeSyncStatus();" btnSn="0101070601" btnName="同步" icon="&#xe6e1;"></jc:operationButton>
        </span> 
    </div>
    <!-- list -->
    <div class="mt-10">
        <table class="table table-border table-bordered table-bg table-hover table-sort" id="tableList">
            <thead>
                <tr class="text-c">
                  <!--  <th width="2%">
                    <input  type="checkbox" id="all" class="checkboxs" >
                    </th> -->
                    <th width="2%"><input type="checkbox" name="goodCheckbox" id="checkbox_id_all"  ></th>
                    <th width="8%">姓名</th>
                    <th width="7%">联系号码</th>
                    <th width="7%">联系方式</th>
                    <th width="10%">前置机</th>
                    <th width="20%">前置机地址</th>
                    <th width="8%">前置机状态</th>
                    <th width="6%">同步状态</th>
                    <th width="8%">创建时间</th>
                    <th width="8%">修改时间</th>
   ...
   <%@ include file="../commons/comm_const_js.jsp"%>
	...
	<script type="text/javascript" src="${contextPath}/js/syncLog/contactWaySyncLog.js?v=${appVerDate}"></script>
