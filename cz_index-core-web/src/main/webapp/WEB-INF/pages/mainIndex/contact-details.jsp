        ...
        <div class="form form-horizontal" style="border: 1px solid #BEBEBE">
            <div class="row cl">
                ...
                <div class="formControls col-9">
                     <font>${contact.mpiId}</font>
                </div>
            </div>
             <div class="row cl">
                <label class="form-label col-2">姓名:</label>
                <div class="formControls col-4">
                   <font>${contact.contactName}</font>
                </div>
                <label class="form-label col-2">证件类别:</label>
                <div class="formControls col-4">
                 <jc:labelDictionaryByKey_Code key="indexCertificateTypeCode" code="${contact.certificateTypeCode}" id="certificateTypeCode"></jc:labelDictionaryByKey_Code>
                </div>
            </div>
            ...
            <div class="row cl">
                ...
                <div class="formControls col-4">
                   <font>${contact.certificateNo }</font>
                </div>
                <label class="form-label col-2">电话:</label>
                <div class="formControls col-4">
                   <font>${contact.contactNo }</font>
                </div>
            </div>
             <div class="row cl">
                 <label class="form-label col-2">创建机构:</label>
                <div class="formControls col-4">
                   <jc:labelHospitalByKey key="${contact.createUnit }"  id="createUnit"></jc:labelHospitalByKey>
                </div>
                <label class="form-label col-2">修改机构:</label>
                <div class="formControls col-4">
                    <jc:labelHospitalByKey key="${contact.lastModifyUnit }"  id="lastModifyUnit"></jc:labelHospitalByKey>
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-2">创建人:</label>
                <div class="formControls col-4">
                   <font>${contact.creatorUser.name }</font>
                </div>
                <label class="form-label col-2">创建时间:</label>
                <div class="formControls col-4">
                  <font><fmt:formatDate value="${contact.createDate }" pattern="yyyy-MM-dd HH:mm:ss"/></font>
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-2">修改人:</label>
                <div class="formControls col-4">
                   <font>${contact.updatorUser.name }</font>
                </div>
                <label class="form-label col-2">修改时间:</label>
                <div class="formControls col-4">
                  <font><fmt:formatDate value="${contact.updateDate }" pattern="yyyy-MM-dd HH:mm:ss"/></font>
                </div>     
            </div>
