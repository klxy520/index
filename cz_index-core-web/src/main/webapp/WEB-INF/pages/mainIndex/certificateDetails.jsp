    ...
    <div class="pd-20">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-9">
                <font>${certificate.mpiId}</font>
            </div> 
        </div>
        <div class="row cl">
             <label class="form-label col-2">证件类型:</label>
            <div class="formControls col-4">
                <jc:labelDictionaryByKey_Code key="indexCertificateTypeCode" code="${certificate.certificateTypeCode}" id="certificateTypeCode"></jc:labelDictionaryByKey_Code>
            </div>
             <label class="form-label col-2">证件号码:</label>
            <div class="formControls col-4">
             <font>${certificate.certificateNo}</font>
            </div>     
        </div>
        <div class="row cl">
             <label class="form-label col-2">创建机构:</label>
            <div class="formControls col-4">
              <jc:labelHospitalByKey key="${certificate.createUnit }"  id="createUnit"></jc:labelHospitalByKey>
            </div> 
             <label class="form-label col-2">修改机构:</label>
            <div class="formControls col-4">
              <jc:labelHospitalByKey key="${certificate.lastModifyUnit }"  id="lastModifyUnit"></jc:labelHospitalByKey>
            </div> 
        </div>
        <div class="row cl">
         <label class="form-label col-2">创建人:</label>
            <div class="formControls col-4">
             <font>${certificate.creatorUser.name}</font> 
            </div> 
             <label class="form-label col-2">创建时间:</label>
            <div class="formControls col-4">
               <fmt:formatDate value="${certificate.createDate}" pattern="yyyy-MM-dd HH:mm:ss" /> 
            </div> 
        ...
        <div class="row cl">
          <label class="form-label col-2">修改人:</label>
            <div class="formControls col-4">
              <font>${certificate.updatorUser.name}</font> 
            </div> 
