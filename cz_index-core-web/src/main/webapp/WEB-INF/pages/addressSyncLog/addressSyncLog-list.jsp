...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span>同步日志管理<span class="c-gray en">&gt;</span>地址信息日志<a class="btn btn-success radius r mr-20" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div style="padding:0 20px 20px 20px;">
    ...
    <div class="text-c form form-horizontal banner_xiala"> 
        <div class="row cl">
            ...
            <div class="formControls col-2">
                <jc:selectDictionaryByKey_Code classname="input-text" key="indexAddressTypeCode" id="addressTypeCode" name="addressTypeCode"></jc:selectDictionaryByKey_Code>
            </div>
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-10"> 
        <span class="l">
            <jc:operationButton classname="btn btn-primary radius" onclick="syncLogAddress();" btnSn="0101070201" btnName="同步" icon="&#xe6e1;"></jc:operationButton>
        </span> 
    </div>
    <!-- list -->
    <div class="mt-10">
        <table class="table table-border table-bordered table-bg table-hover table-sort" id="contactSyncLogList">
            <thead>
                <tr class="text-c">
...
<script type="text/javascript" src="${contextPath}/js/addressSyncLog/addressSyncLog-list.js?v=${appVerDate}"></script>
</body> 
</html>
