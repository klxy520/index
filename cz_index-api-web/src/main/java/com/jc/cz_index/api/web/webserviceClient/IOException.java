...
public class IOException extends org.apache.axis.AxisFault implements java.io.Serializable {
    ...
    // Type metadata
    private static org.apache.axis.description.TypeDesc typeDesc = new org.apache.axis.description.TypeDesc(IOException.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://webservice.web.api.cz_index.jc.com/", "IOException"));
