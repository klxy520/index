...
public class StringUtils {
    ...
    /**
     * 
     * @Title: isNumeric @Description:判断字符串是数字 数组中有一个不是数字就返回false @param @param
     *         strArray @param @return @return boolean @throws
     */
    ...
    /**
     * 
     * @Title: StringToInt @Description:string -> int @param @param str @param @return @return
     *         int @throws
     */
    ...
    /**
     * 
     * @Title: StringToShort @Description: string -> short @param @param str @param @return
     *         参数说明 @return short 返回类型 @throws
     */
    ...
    /**
     * 
     * @Title: StringToLong @Description:string -> long @param @param str @param @return @return
     *         int @throws
     */
    ...
    /**
     * 
     * @Title: isNumeric @Description:判断字符串是数字 @param @param str @param @return @return
     *         boolean @throws
     */
    ...
    /**
     * 
     * @Title: getStringList @Description:将(逗号)分隔的字符串 将分隔成list @param @param str @param @return @return
     *         List<String> @throws
     */
    ...
    /**
     * 
     * @Title: getIntByRandom @Description:获取指定范围的整数，指定返回个数，不重复 @param @param
     *         count @param @param range @param @return @return int[] @throws
     */
    ...
    /**
     * 
     * @Title: saveTwoDecimal @Description:保留两位小数 @param @param price @param @return @return
     *         double @throws
     */
    public static String savePriceTwoDecimal(double price) {
        ...
        if (!CollectionsUtils.isNull(priceStrArry) && priceStrArry.length == 2 && isEmpty(priceStrArry[0])) {
            priceStr = "0" + priceStr;
        }
        return priceStr;
    }
    ...
    /**
     * 
     * @Title: formatStringByRegex @Description:根据正则表达式，格式化数据 13812345678 根据
     *         $1****$3 ->138****5678 @param @param value @param @param format @param @return @return
     *         String @throws
     */
    ...
    /**
     * 
     * @Title: StringToDouble @Description:格式化 double字符串,去掉, @param @param str @param @return @return
     *         double @throws
     */
    ...
    /**
     * 
     * @Title: equalsByRegex @Description:根据正则表达式 匹配字符串 @param @param value @param @param
     *         regex @param @return @return boolean @throws
     */
    ...
    /**
     * 
     * @Title: decode @Description: 处理编码 和特殊字符(% +) @param @param data @param @return
     ...
     * @return
     */
    public static String add0(String str, int length) {
        if (isEmpty(str)) {
            return null;
        }
    ...
    /**
     * 
     * 描述：List转换为字符串并加入分隔符方法
     * 
     * @param list
     * @param separator
     * @return
     * @author zhangli 2016年10月12日 上午11:40:14
     * @version 1.0
     */
    public static String listToString(List<Long> list, char separator) {
     ...
     * @param str
     * @return
     * @author yangyongchuan 2016年11月8日 上午10:56:42
     * @version 1.0
     */
     ...
     * @param length
     * @return
     * @author yangyongchuan 2016年11月8日 下午1:30:49
     * @version 1.0
     */
     ...
     * 
     * @return
     * @author zhangli 2016年11月2日 上午9:56:44
     * @version 1.0
     */
     ...
     * @param length
     * @return
     * @author yangyongchuan 2016年11月16日 上午9:46:59
     * @version 1.0
     */
    ...
    /***
     * 
     * 描述：判断两个字符串的值是否相同(相同为真,不同为假)
     * 
     * @param string
     * @param string2
     * @return
     * @author sunxuefeng 2017年8月31日 上午11:32:21
     * @version 1.0
     */
    ...
    /**
     * 
     * 描述：判断两个long变量是否为空或者为0
     * 
     * @return
     * @author sunxuefeng 2017年10月12日 上午11:24:59
     * @version 1.0
     */
    public static boolean compareIsNull(Long number1, Long number2) {
     ...
     * @param strEnd
     * @return
     * @author fengshengliang 2017年12月29日 下午2:27:34
     * @version 1.0
     */
    public static String getInsideString(String str, String strStart, String strEnd) {
        ...
        return str.substring(str.indexOf(strStart), str.indexOf(strEnd) + strEnd.length());
    }
}